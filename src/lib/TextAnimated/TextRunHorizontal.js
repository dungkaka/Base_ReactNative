import React, { cloneElement, forwardRef, useCallback, useEffect, useImperativeHandle, useMemo, useRef } from "react";
import { Animated, Easing, PixelRatio, ScrollView, View } from "react-native";

const TextRunHorizontal = forwardRef(({ style, children, speed = 0.1, delay = 0, autoPlay = true, playing }, ref) => {
    ...
    const start = (currentOffset = 0) => {
        ...
        const durationByValue = PixelRatio.getPixelSizeForLayoutSize(-value + currentOffset) / speed;
...
export default TextRunHorizontal;
